    ...
    try:
        ...
        if hands:
            ...
            if fingers1[0] == 1:
                ...
                currentFingerUp = "indexfinger"
            elif fingers1[2] == 1:
                currentFingerUp = "middlefinger"
            elif fingers1[3] == 1:
                currentFingerUp = "ringfinger"
            elif fingers1[4] == 1:
                currentFingerUp = "littlefinger"
            else:
                currentFingerUp=""

            # Show the currentFingerUp value on the camera feed
            cv2.putText(cameraFeedImg, handType1 + " : " + currentFingerUp, (75, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
